...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/FirebaseCoreExtension-iOS/FirebaseCoreExtension.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/FirebaseMessaging-iOS/FirebaseMessaging.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/FirebaseSessions-iOS/FirebaseSessions.framework"
