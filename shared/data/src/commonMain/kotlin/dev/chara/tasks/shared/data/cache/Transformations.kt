...
@JvmName("toTaskModel")
fun Collection<SqlTask>.toModel() = map { it.toModel() }
fun SqlTask.toModel() = Task(
    this.id,
    this.list_id,
...
fun Collection<SqlTaskList>.toModel() = map { it.toModel() }
fun SqlTaskList.toModel() = TaskList(
    this.id,
